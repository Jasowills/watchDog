...
export function NotFoundPage() {
  return (
    <div className="flex min-h-[50vh] flex-col items-start justify-center rounded-[2rem] border border-[var(--border-soft)] bg-[var(--surface-panel)] p-8 dark:border-[var(--border-soft)]">
      <p className="text-[0.7rem] font-semibold uppercase tracking-[0.24em] text-[var(--text-muted)]">Route not found</p>
      <h2 className="mt-4 font-[var(--font-display)] text-4xl tracking-[-0.04em] text-[var(--text-main)]">That page is not part of the current shell.</h2>
