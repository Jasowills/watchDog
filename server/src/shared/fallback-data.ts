...
export const fallbackErrorGroups = [
  {
    id: 'error-group_typeerror-cart',
  ...
  {
    id: 'error-group_prisma-billing',
    fingerprint: 'billing-worker:PrismaClientKnownRequestError',
    title: 'PrismaClientKnownRequestError: Unique constraint failed',
    status: 'OPEN',
    occurrenceCount: 29,
    firstSeenAt: minutesAgo(124),
  ...
  {
    id: 'error-group_socket-hangup',
    fingerprint: 'public-api:FetchError:socket-hangup',
    title: 'FetchError: socket hang up',
    status: 'OPEN',
    occurrenceCount: 11,
    firstSeenAt: minutesAgo(180),
    lastSeenAt: minutesAgo(41),
    projectId: fallbackProjects[0].id,
    environmentId: fallbackEnvironments[0].id,
    serviceId: fallbackServices[0].id,
    environment: fallbackEnvironments[0],
